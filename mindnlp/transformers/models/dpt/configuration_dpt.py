...
class DPTConfig(PretrainedConfig):
    ...
    Args:
        ...
        backbone (`str`, *optional*):
            ...
            will load the corresponding pretrained weights from the timm or transformers library. If
            `use_pretrained_backbone` is `False`, this loads the backbone's config and uses that to
