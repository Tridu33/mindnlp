...
class DPTImageProcessor(BaseImageProcessor):
    ...
    def preprocess(
        ...
        Args:
            ...
            return_tensors (`str` or `TensorType`, *optional*):
                The type of tensors to return. Can be one of:
                    ...
                    - `TensorType.MINDSPORE` or `'ms'`: Return a batch of type `mindspore.Tensor`.
        ...
        if not valid_images(images):
            raise ValueError(
                ...
                "torch.Tensor, tf.Tensor, ms.Tensor or jax.ndarray."
            )
        validate_preprocess_arguments(
    ...
    # Copied from transformers.models.beit.image_processing_beit.BeitImageProcessor.post_process_semantic_segmentation
    # with Beit->DPT
    def post_process_semantic_segmentation(self, outputs, target_sizes: Union[List[Tuple], mindspore.Tensor] = None):
        """
        Converts the output of [`DPTForSemanticSegmentation`] into semantic segmentation maps. Only supports MindSpore.
