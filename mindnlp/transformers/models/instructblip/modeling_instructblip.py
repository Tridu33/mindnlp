...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def forward(
        ...
        query_output = query_outputs[0][:, : query_tokens.shape[1], :]
    ...
    def generate(
        ...
        **generate_kwargs,
        ...
        Args:
            ...
            qformer_input_ids (`mindspore.Tensor` of shape (batch_size, sequence_length), *optional*):
                The sequence used as a prompt to be fed to the Q-Former module.
            qformer_attention_mask (`mindspore.Tensor` of shape (batch_size, sequence_length), *optional*):
        ...
        query_output = query_outputs.last_hidden_state[:, : query_tokens.shape[1], :]
