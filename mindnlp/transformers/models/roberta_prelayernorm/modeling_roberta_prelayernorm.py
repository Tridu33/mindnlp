...
"""MindSpore RoBERTa-PreLayerNorm model."""
...
class RobertaPreLayerNormEmbeddings(nn.Module):
    ...
    def create_position_ids_from_inputs_embeds(self, inputs_embeds):
        ...
        return position_ids.unsqueeze(0).broadcast_to(tuple(input_shape))
...
# Copied from transformers.models.roberta.modeling_roberta.RobertaForCausalLM with FacebookAI/roberta-base->andreasmadsen/efficient_mlm_m0.40,ROBERTA->ROBERTA_PRELAYERNORM,Roberta
# ->RobertaPreLayerNorm,roberta->roberta_prelayernorm, RobertaPreLayerNormTokenizer->RobertaTokenizer
